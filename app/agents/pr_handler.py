...
#     """
#     Handles pushing optimised pipeline YAML to GitHub and optionally creating a PR.
#     """

#     def __init__(self, gh_token: str | None = None):
#         """
#         Initialize PRHandlerAgent.
...
#         logger.info("Initialized PRHandlerAgent with provided GitHub token")
...
#     ) -> str | None:
#         """
#         Push optimised YAML to repo and optionally create a PR.
...
#         Returns:
#             URL of created PR, or None if pr_create=False or PR exists
#         """
...
#         logger.info("Base branch: %s (SHA: %s)", base_branch, source.commit.sha[:7])
