"""
Pipeline Repository - Data access layer for pipeline optimization
...
class PipelineRepository:
    """
    Repository for pipeline optimization data.
    
    Encapsulates all database operations related to:
    - Repository tracking
    - Run lifecycle
    - Artifact storage
    - Issue tracking
    ...
    def start_run(
        ...
        """
        logger.debug(
            f"Starting run for repo: {repo_url}",
