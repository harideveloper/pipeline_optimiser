OPTIMISER_SYSTEM_PROMPT = """You are a CI/CD pipeline optimisation expert. Analyze this GitHub Actions workflow and create a detailed optimisation plan.
...
OPTIMISER_EXECUTION_PROMPT = """You are implementing an optimisation plan for a GitHub Actions workflow.
